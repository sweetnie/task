...
public class RestaurantController {
    ...
    public RestaurantController() {
        ...
        this.restaurantList.add(new Restaurant("Abu Bakar Roti Prata House - Indian cuisine"));
        this.restaurantList.add(new Restaurant("Thai Mookata - Thai cuisine"));
        this.restaurantList.add(new Restaurant("Dagalbi - Korean cuisine"));
    }
